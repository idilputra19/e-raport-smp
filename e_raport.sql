...
--
-- Host: localhost
-- Generation Time: Feb 17, 2025 at 07:15 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','guru','siswa','kepala_sekolah','orang_tua') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'admin', '$2y$10$W2GFg0Xx7RsxciTm4EdvE.Z7Zj0giC348C9KZ3M.jsvIMSKuueyEi', 'admin');
